...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      {/* Header */}
      <div className="pt-28 sm:pt-36 pb-10 sm:pb-14 px-5 sm:px-8 lg:px-12 max-w-screen-2xl mx-auto">
      ...
      {/* Contact details */}
      <div className="px-5 sm:px-8 lg:px-12 max-w-screen-2xl mx-auto pb-24">
        {fields.length === 0 ? (
