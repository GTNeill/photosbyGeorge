      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-3 mb-6">
          <input
            ...
            required
            className="w-full h-12 px-4 bg-[#141414] border border-[#2A2A2A] text-[#F0F0F0] text-sm placeholder:text-[#5A5A5A] focus:outline-none focus:border-[#C8A96E] transition-colors"
          />
          <input
            type="password"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-12 bg-[#C8A96E] text-[#0A0A0A] text-sm font-semibold hover:bg-[#b8996e] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
